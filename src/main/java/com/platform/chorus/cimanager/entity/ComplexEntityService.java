 ...
 */
public class ComplexEntityService extends AbstractEntityService {
    final static private Logger logger = LoggerFactory.getLogger(ComplexEntityService.class);

    public ComplexEntityService(Entity entity, List<Value> values, EntityDao entityDao, ValueDao valueDao) {
